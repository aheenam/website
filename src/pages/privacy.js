...
const PrivacyPage = () => {
  return (
    <Layout>
      <section className="max-w-570px">
        <h1 className="font-serif font-bold text-2xl mb-4">Privacy Policy</h1>
        <p className="mb-4">
        ...
        <p className="mb-4">Our privacy policy is structured as follows:</p>
        <p className="mb-4">
        ...
        <h2 className="font-bold">II. The rights of users and data subjects</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          View, CA 94043 (hereinafter: Google).
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          interest lies in the analysis, optimization, and economic operation of
          our site.
        </p>
        <p className="mb-4">
          ...
          Google truncates the IP address within the EU or the EEA before it is
        ...
        <p className="mb-4">
          ...
          there. This data can also be used to provide other services related to
        ...
        <p className="mb-4">In addition, Google offers an opt-out add-on at</p>
        <p className="mb-4">
          <a
            className="underline"
        ...
        <p className="mb-4">
          in addition with further information. This add-on can be installed on
          the most popular browsers and offers you further control over the data
          that Google collects when you visit our website. The add-on informs
          Google Analytics' JavaScript (ga.js) that no information about the
          website visit should be transmitted to Google Analytics. However, this
          does not prevent information from being transmitted to us or to other
          web analytics services we may use as detailed herein.
        </p>

        <h3 className="font-bold">Google Fonts</h3>
        <p className="mb-4">
        ...
        <p className="mb-4">Google offers detailed information at</p>
        <p className="mb-4">
          <a
            className="underline"
        ...
        <h3 className="font-bold">MailChimp - Newsletter</h3>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          Means Street, Suite 404, Atlanta, GA 30318, USA, hereinafter referred
          to as "The Rocket Science Group".
        </p>
        <p className="mb-4">
          Through certification according to the EU-US Privacy Shield
        </p>
        ...
        <p className="mb-4">
          the Rocket Science Group guarantees that it will follow the EU's data
          protection regulations when processing data in the United States. In
          addition, the Rocket Science Group offers further information about
          its data protection practices at
        </p>
        <p className="mb-4">
          <a
            className="underline"
        ...
        <p className="mb-4">
          ...
          description of the type of content it will offer and reference made to
          this privacy policy.
        </p>
        <p className="mb-4">
          ...
          evaluate whether and when you have read our newsletter and whether you
          have clicked any links contained therein. In addition to further
          technical data, such as data about your computer hardware and your IP
          address, the data processed will be stored so that we can optimize our
          newsletter and respond to the wishes of our readers. The data will
          therefore increase the quality and attractiveness of our newsletter.
        </p>
        <p className="mb-4">
          The legal basis for sending the newsletter and the analysis is Art. 6
          Para. 1 lit. a) GDPR.
        </p>
        <p className="mb-4">
          You may revoke your prior consent to receive this newsletter under
